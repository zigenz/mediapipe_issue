...
TARGET_ROOT_PATH="../third_party/mediapipe"
...
bazel build -c opt --strip=ALWAYS --host_crosstool_top=@bazel_tools//tools/cpp:toolchain --fat_apk_cpu=arm64-v8a,armeabi-v7a //${TARGET_FOLDER_NAME}:speqs_mediapipe_aar.aar
