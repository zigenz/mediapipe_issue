...
open class EyeTestActivityBase : AppCompatActivity() {
    ...
    private var manifestApplicationInfo: ApplicationInfo? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        processor = FrameProcessor(
            ...
            manifestApplicationInfo!!.metaData?.getString("binaryGraphName"),
            manifestApplicationInfo!!.metaData?.getString("inputVideoStreamName"),
            manifestApplicationInfo!!.metaData?.getString("outputVideoStreamName")
        )
        processor!!
            .videoSurfaceOutput
            .setFlipY(
    ...
    fun startCamera() {
        ...
        val cameraFacing = if (manifestApplicationInfo!!.metaData.getBoolean(
                "cameraFacingFront",
                false
            )
